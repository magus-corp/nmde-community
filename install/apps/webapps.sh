...
if [ -z "$nmde_BARE" ]; then
  ...
  # web2app "magus-corp" https://launchpad.37signals.com https://magus-corp.com/assets/images/general/magus-corp.png
  ...
  # web2app "nmde Manual" https://manuals.omamix.org/2/the-nmde-manual https://cdn.jsdelivr.net/gh/homarr-labs/dashboard-icons/png/arch-linux.png
fi
